  ...
  return (
    <div>
      ...
      <div className={classes.lineBackground}>
        ...
        <Divider className={classes.divider} />
        <Typography variant="h4" className={cx(Type.light, Type.uppercase)} gutterBottom>
          Vestibulum nec mi
          <span className={Type.bolder}>
            suscipit
          </span>
        ...
        <Typography variant="h6" className={Type.light} gutterBottom>
          ...
          looks great! 1234
          <span className={cx(Type.bold, Type.italic, Type.underline)}>
            56
          </span>
          7890
        </Typography>
