...
const useStyles = makeStyles()((theme, _params, classes) => ({
  ...
  listItem: {
    ...
    '&:hover': {
      backgroundColor: theme.palette.mode === 'dark' ? darken(theme.palette.background.paper, 0.3) : theme.palette.secondary.light
    },
    [`&.${classes.done}`]: {
  ...
  clockWrap: {
    ...
    '& > time': {
      ...
      boxShadow: theme.palette.mode === 'dark' ? `0 0 0 10px ${alpha(theme.palette.secondary.main, 0.6)}` : `0 0 0 10px ${alpha(theme.palette.secondary.light, 0.6)}`,
      borderRadius: '50%',
      '& > div': {
